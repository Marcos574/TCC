...
\begin{figure}[h]
	...
	\includegraphics[width=17cm]{figuras/principios.png} % leia abaixo
...
A atividade da prototipação é primordial para diminuir o mais rápido possível no projeto os riscos e indefinições. Neste sentido, é a forma mais barata e rápida de resolver os problemas citados.
...
É importante ressaltar que prototipar não é somente a atividade de criação do protótipo, essa é apenas a primeira atividade. Talvez a parte mais valiosa da prototipação são os insights e feedbacks obtidos a partir do protótipo em si.
